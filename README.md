...
# ssm216公司人力资源管理系统设计实现+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=15)
...
随着计算机技术的发展以及计算机网络的逐渐普及，互联网成为人们查找信息的重要场所，二十一世纪是信息的时代，所以信息的交换和信息流通显得特别重要。因此，开发合适的V公司人力资源管理系统成为企业必然要走的一步棋。开发合适的V公司人力资源管理系统，可以方便管理人员对V公司人力资源管理系统的管理，提高信息管理工作效率及查询效率，有利于更好的为员工用户提供服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。V公司人力资源管理系统的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

企业如果还用之前的人工记账形式的管理，已经很落伍了，这样会导致了效率低下。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给员工用户的查询带来了很大便利，因此设计一个V公司人力资源管理系统刻不容缓，能够提高企业在信息技术方面的展示水平。
## 1.3系统设计思想
...
# 3系统分析
## 3.1可行性分析
通过对本V公司人力资源管理系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本V公司人力资源管理系统采用JAVA作为开发语言，Spring Boot框架，是基于WEB平台的B/S架构系统。
...
因此，V公司人力资源管理系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本V公司人力资源管理系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本V公司人力资源管理系统的界面简单易操作，员工用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此V公司人力资源管理系统要严格控制管理权限，具体要求如下：

（1）要想对V公司人力资源管理系统进行管理，首先要依靠员工用户名和密码在系统中登陆，无权限的员工用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
本系统是基于B/S架构的网站系统，设计的员工用户功能结构图如下图所示：
...
图4.14 考核标准实体属性图
### 4.3.2数据库设计表
V公司人力资源管理系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|kaohepingfen|varchar(200)|是|NULL|考核评分|
|jixiao|int(11)|是|NULL|绩效|
表4.2 考核结果
...
|kaohefengmian|varchar(200)|是|NULL|考核封面|
|kaoheriqi|varchar(200)|是|NULL|考核日期|
|kaoheneirong|varchar(200)|是|NULL|考核内容|
|kaohepingfen|varchar(200)|是|NULL|考核评分|
|jixiao|int(11)|是|NULL|绩效|
|kaohepingjia|longtext|是|NULL|考核评价|
表4.3 缺勤扣钱标准
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|queqintianshu|int(11)|是|NULL|缺勤天数|
|queqinkouqian|int(11)|是|NULL|缺勤扣钱|
表4.4 人事变更
...
|bumen|varchar(200)|是|NULL|部门|
|zhiwei|varchar(200)|是|NULL|职位|
|genggaishijian|datetime|是|NULL|更改时间|
表4.5管理员表
...
|xiujiatianshu|int(11)|是|NULL|休假天数|
|xiujiakaishiriqi|date|是|NULL|休假开始日期|
...
|bumen|varchar(200)|是|NULL|部门|
|zhiwei|varchar(200)|是|NULL|职位|
|jichugongzi|int(11)|是|NULL|基础工资|
|jiabanbutie|int(11)|是|NULL|加班补贴|
|chuchajintie|int(11)|是|NULL|出差津贴|
|queqintianshu|int(11)|是|NULL|缺勤天数|
|queqinkouqian|int(11)|是|NULL|缺勤扣钱|
|shijigongzi|int(11)|是|NULL|实际工资|
表4.9 员工考核登记
...
|zhiwei|varchar(200)|是|NULL|职位|
|kaohefengmian|varchar(200)|是|NULL|考核封面|
|kaoheriqi|date|是|NULL|考核日期|
|kaoheneirong|longtext|是|NULL|考核内容|
表4.10 员工考勤记录
...
|bumen|varchar(200)|是|NULL|部门|
|zhiwei|varchar(200)|是|NULL|职位|
|kaoqintianshu|int(11)|是|NULL|考勤天数|
...
## 5.1 管理员模块的实现
### 5.1.1 考核标准管理
V公司人力资源管理系统的系统管理员可以管理考核标准信息，可以对考核标准信息添加修改删除操作。具体界面的展示如图5.1所示。

![](/md/blog.010.png)

图5.1 考核标准管理界面
### 5.1.2 缺勤扣钱标准管理
系统管理员可以对缺勤扣钱标准进行管理操作。具体界面如图5.2所示。

![](/md/blog.011.png)

图5.3 缺勤扣钱标准管理界面
### 5.1.3 登记员工工资
系统管理员可以登记员工工资。界面如下图所示：
...
## 5.2 员工用户模块的实现
### 5.2.1 添加休假申请
员工用户登录后，可以添加休假申请信息，包括休假天数，申请原因，休假开始日期等信息都需要登记。界面如下图所示：

![](/md/blog.013.png)

图5.5 添加休假申请界面
### 5.2.2 考核结果管理
员工用户登录后，可以查看考核结果信息。界面如下图所示：

![](/md/blog.014.png)

图5.6 考核结果管理界面
### 5.2.3 员工考核登记管理
员工用户登录后可以对考核信息进行修改，删除。界面如下图所示：
